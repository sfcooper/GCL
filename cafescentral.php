...
$conn = dbConnectpdo();
$sql = "SELECT COUNT(*) FROM cafes WHERE cafe_area = 'central'";
...
$result->closeCursor();
//prepare second db query
$getDetails = "SELECT * FROM cafes WHERE cafe_area = 'central'";
...
<h1>Central London Coffee</h1>
<?php foreach ($conn->query($sql) as $row) { ?>

<p>I've currently listed a total of <?php echo "$numRows"; ?> cafes in central London.</p>
<?php } ?>
               <h3>Map</h3>


               <div class="uk-grid-divider uk-child-width-expand@s" uk-grid>
<iframe async src="https://www.google.com/maps/d/u/0/embed?mid=1bupBcDXJoLB8gI10Ij8sfnC-ic0&hl=en" width="100%" height="480"></iframe>
