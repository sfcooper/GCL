...
<html lang="en">
  <head>
    ...
    <title>Gourmet Coffee London - Cookie Policy</title>
  </head>
  <body>
        ...
        <div class="uk-card uk-card-default uk-card-body">
          <article class="uk-article">
                     ...
                     <h3>The Cookies We Set</h3>
                     		  ...
                     		  <p>Currently we only set one cookie ourselves (1st Party Cookie) which is to store your decision on agreeing to accept cookies or not.</p>
                     ...
                     We also use social media buttons and/or plugins on this site that allow you to connect with your social network in various ways. For these to work the following social media sites including; Facebook and Twitter and will set cookies through our site which may be used to enhance your profile on their site or contribute to the data they hold for various purposes outlined in their respective privacy policies.</p>
